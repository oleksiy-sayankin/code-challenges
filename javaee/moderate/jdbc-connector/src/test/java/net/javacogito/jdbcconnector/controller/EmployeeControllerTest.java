...
public class EmployeeControllerTest extends AbstractControllerTest<Employee, Integer> {
  ...
  @Test public void insertTest() {
    ...
    Assert.assertTrue(employees.contains(createEmployee("Tonya", "Miller", 32, 1, 1, 4300.43f)));
    Assert.assertTrue(employees.contains(createEmployee("Donald", "Shea", 28, 1, 3, 11300.11f)));
    Assert.assertTrue(employees.contains(createEmployee("Timmy", "Jones", 34, 2, 2, 32300.39f)));
    Assert.assertFalse(employees.contains(createEmployee("No Name", "No Name", 34, 2, 2, 32300.39f)));
  }
  ...
  @Override protected void insertData() {
    Assert.assertTrue(controller.insert(createEmployee("Tonya", "Miller", 32, 1, 1, 4300.43f)));
    Assert.assertTrue(controller.insert(createEmployee("Donald", "Shea", 28, 1, 3, 11300.11f)));
    Assert.assertTrue(controller.insert(createEmployee("Timmy", "Jones", 34, 2, 2, 32300.39f)));
  }
}
