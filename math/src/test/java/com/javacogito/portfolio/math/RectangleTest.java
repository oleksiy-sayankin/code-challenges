...
public class RectangleTest {
    ...
    public void rectangleConstructorTest() {
        ...
        assertEquals(rectangleA.area(), rectangleB.area(), MathConstants.ERROR);
    ...
    public void rectangleEqualsFalseTest() {
        ...
        assertEquals(rectangleA.area(), rectangleB.area(), MathConstants.ERROR);
        assertEquals(rectangleA.area(), rectangleC.area(), MathConstants.ERROR);
        assertEquals(rectangleB.area(), rectangleC.area(), MathConstants.ERROR);
